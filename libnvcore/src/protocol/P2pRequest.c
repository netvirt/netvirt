...
static int
memb_ipAddrLocal_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const OCTET_STRING_t *st = (const OCTET_STRING_t *)sptr;
	size_t size;
...
static asn_TYPE_member_t asn_MBR_P2pRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct P2pRequest, macAddrDst),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct P2pRequest, ipAddrDst),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct P2pRequest, port),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_port_4,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct P2pRequest, side),
	...
	{ ATF_POINTER, 1, offsetof(struct P2pRequest, ipAddrLocal),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		memb_ipAddrLocal_constraint_1,
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"ipAddrLocal"
		},
};
static ber_tlv_tag_t asn_DEF_P2pRequest_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_P2pRequest_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* macAddrDst */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ipAddrDst */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* port */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* side */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* ipAddrLocal */
};
static asn_SEQUENCE_specifics_t asn_SPC_P2pRequest_specs_1 = {
	sizeof(struct P2pRequest),
	offsetof(struct P2pRequest, _asn_ctx),
	asn_MAP_P2pRequest_tag2el_1,
	5,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	3,	/* Start extensions */
	6	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_P2pRequest = {
	"P2pRequest",
	"P2pRequest",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0, 0,	/* No PER support, use "-gen-PER" to enable */
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_P2pRequest_tags_1,
	sizeof(asn_DEF_P2pRequest_tags_1)
		/sizeof(asn_DEF_P2pRequest_tags_1[0]), /* 1 */
	asn_DEF_P2pRequest_tags_1,	/* Same as above */
	sizeof(asn_DEF_P2pRequest_tags_1)
		/sizeof(asn_DEF_P2pRequest_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_P2pRequest_1,
	5,	/* Elements count */
	&asn_SPC_P2pRequest_specs_1	/* Additional specs */
};

...
int
SearchRequest_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
SearchRequest_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
SearchRequest_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	SearchRequest_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
SearchRequest_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
SearchRequest_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SearchRequest_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
SearchRequest_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SearchRequest_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_SearchRequest = {
	...
	SearchRequest_free,
	SearchRequest_print,
	SearchRequest_constraint,
	SearchRequest_decode_ber,
	SearchRequest_encode_der,
	SearchRequest_decode_xer,
	SearchRequest_encode_xer,
